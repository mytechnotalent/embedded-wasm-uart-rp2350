...
//!
//! # Build Script for embedded-wasm-uart Firmware
//!
//! Sets up the RP2350 linker script, compiles the WASM UART echo application,
//! encodes it as a WASM component, and AOT-compiles to Pulley bytecode for
//! the RP2350.
...
/// Compiles the WASM UART echo application for the `wasm32-unknown-unknown` target.
///
/// # Panics
///
...
/// # Arguments
///
/// * `out` - Output directory path where `uart_echo.cwasm` will be placed.
///
/// # Panics
///
